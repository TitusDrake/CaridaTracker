...
- **Project Planning** — GitHub Projects CLI (`gh project`) is available; preferred to break planning into GitHub Issues to track work; always assign to `TitusDrake` and add to `TitusDrakeDevelopment` project
